describe("Users Zodiac Horoscope Reading Pages", () => {
  describe("Show todays reading", () => {
    it("Should display todays reading for the selected Zodiac", () => {
      ...
      cy.get(".reading-card")
        .should("be.visible")
        .should("contain", "Date: September 27, 2021")
        .should(
          "contain",
    ...
    it("Should be able to click yesterdays reading button and display yesterdays reading for the selected Zodiac", () => {
      ...
      cy.get(".reading-card")
        .should("be.visible")
        .should("contain", "Date: September 26, 2021")
        .should(
          "contain",
          "You dont need to prove your worth to those who are not part of your close circle. Stay positive."
        );
    });
    ...
    it("Should be able to click tomorrows reading button and display tomorrows reading for the selected Zodiac", () => {
      ...
      cy.get(".reading-card")
        .should("be.visible")
        .should("contain", "Date: September 28, 2021")
        .should(
          "contain",
          "Description: You can be whatever and whoever you'd like. Stay motivated today."
        );
    });
  });
